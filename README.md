...
![AI智能助手](docs/images/06_ai_chat.png)

### 公司介绍
深圳快滴收科技有限公司详细介绍页面，展示公司核心业务（国际海运、中欧班列、中亚卡车、国际空派、国际快递、海外仓储、展会物流）、HS编码智能查询系统功能介绍及联系方式。

![公司介绍](docs/images/07_about.png)

### 用户登录/注册
用户认证页面，支持用户名密码登录、记住登录状态、新用户注册等功能。

![用户登录](docs/images/08_login.png)

![用户注册](docs/images/09_register.png)

### 管理后台
系统管理控制台，提供系统概览、用户管理、知识库管理、HS编码管理、系统配置、大模型配置等功能模块。

![管理后台](docs/images/10_admin.png)
